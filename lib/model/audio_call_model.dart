class AudioCallModel {
  ...
  AudioCallModel({this.callerEmail,this.callerName,this.callerPic,this.callerUid,this.id,this.receiverEmail,this.receiverName,this.receiverPic,this.receiverUid,this.status});
